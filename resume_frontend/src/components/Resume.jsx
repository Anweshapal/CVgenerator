...
const Resume = ({ data }) => {
  ...
  //   documentTitle:data.personalInformation.fullName,
 ...
 const handleDownloadPdf = () => {
  ...
  toPng(resumeRef.current, { quality: 1.0 })
    .then((dataUrl) => {
      ...
      img.onload = () => {
        const imgWidth = 190; // PDF page width margin approx
    ...
    <>
      ...
      >
        ...
        <section>
          ...
          <p className="text-gray-700 dark:text-gray-300">{data?.summary || "Summary goes here."}</p>
        </section>
